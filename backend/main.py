...
from anthropic_client import SmritiMedsAPIError, analyze_extracted_text, analyze_medication_images
from config import load_config, load_env_file
from local_pill_pipeline import analyze_local_pills
from ocr_models import OCRUnavailableError, backend_status, route_ocr_document
from pill_identifier_model import local_model_status
    ...
    return JSONResponse(
        {
            ...
            "message": "Backend is running. Open the React frontend at http://127.0.0.1:5173 or call /api/health.",
