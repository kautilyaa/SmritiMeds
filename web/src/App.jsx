...
const MODES = [
  {
    value: "auto",
    title: "Auto Route",
    subtitle: "Best default for most workflows",
        ...
        <section className="hero-card">
          <div className="hero-copy-wrap">
            <div className="brand-row">
              <img className="brand-icon" src="/icon.png" alt="SmritiMeds icon" />
              <div>
                <p className="eyebrow">SmritiMeds 2.1</p>
                <p className="brand-name">SmritiMeds</p>
              </div>
            </div>
          ...
          <form className="glass-card glass-card--tall" onSubmit={submit}>
            ...
            <label className="toggle-row toggle-row--card">
              ...
              <div>
                ...
                <span>Keep this off unless you specifically want the experimental local models.</span>
              </div>
            </label>
          ...
          <aside className="glass-card glass-card--tall">
            <div className="section-header section-header--stack-mobile">
              <div>
                ...
                <p className="section-subtitle">Know which models are ready before you rely on a given analysis path.</p>
              </div>
            ...
            <div className="glass-card result-card">
              ...
              {result.local_vision ? (
                <div className="content-block">
                  ...
                  {result.local_vision.assessment ? (
                    <div className="fallback-banner fallback-banner--safety">
                      <strong>Visual-only authentication boundary</strong>
                      <p>{result.local_vision.assessment.safety_summary}</p>
                      <div className="metric-grid metric-grid--compact">
                        <StatPill
                          label="Confidence penalty"
                          value={result.local_vision.assessment.visual_only_confidence_penalty}
                          tone="amber"
                        />
                        <StatPill
                          label="Adjusted visual confidence"
                          value={result.local_vision.assessment.adjusted_visual_confidence}
                          tone="teal"
                        />
                      </div>
                      <p className="muted-text">{result.local_vision.assessment.paper_basis}</p>
                      <ul className="stacked-bullets">
                        {(result.local_vision.assessment.risk_factors || []).map((note) => (
                          <li key={note}>{note}</li>
                        ))}
                      </ul>
                    </div>
